...
namespace GpuExample {
    static class EntryPoint {
        ...
        unsafe static void RenderThread (Window window) {
            ...
            //var font = FontCollection.SystemFonts.Load("楷体");
            FontFace font = FontCollection.SystemFonts.Load("arial");
            ...
            buffer.Append(analyzer, font, @"The quick brown fox jumps over the lazy dog.");
